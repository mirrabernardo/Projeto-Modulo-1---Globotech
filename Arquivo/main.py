...
from funcoes import carregar_dados_csv, tratar_e_salvar_csv, agrupar_por_conteudo, tratar_linha, calcular_interacoes_por_conteudo, contar_tipos_interacao_por_conteudo, calcular_media_visualizacao_por_conteudo, listar_comentarios_por_conteudo, top_5_conteudos_mais_vistos, contar_tempo_total_de_visualizacao_por_conteudo
